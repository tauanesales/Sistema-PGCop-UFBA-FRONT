    ...
    return (
        <div  style={{
          ...
          className="cadastroAluno">
            ...
            {/* Seleção de data */}
            <div style={{ marginBottom: '15px' }}>
                <select style={{ width: '30%', padding: '6px', borderRadius: '5px', backgroundColor: '#d3d3d3', color: '#333', fontSize: '14px', border: '1px solid #ccc', marginRight: '5px' }} required>
                ...
                <select style={{ width: '30%', padding: '6px', borderRadius: '5px', backgroundColor: '#d3d3d3', color: '#333', fontSize: '14px', border: '1px solid #ccc' }} required>
                    <option value="">Ano</option>
                    {Array.from({ length: 10 }, (_, i) => <option key={anoAtual - i} value={anoAtual - i}>{anoAtual - i}</option>)}
                </select>
            </div>
            ...
            {/* Botão Cadastrar */}
            <button style={{padding: '5px 20px', borderRadius: '5px', fontSize: '18px' }}>Cadastrar</button>
